...
class PostToOracleRange extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'post:orange {--idAwal=0} {--idAkhir=0}';
    ...
    public function handle()
    {
        ...
        try {
            ...
            DB::connection('mysql')->table('acc_batch_oracle')->insertGetId($batchOracleInsert);
